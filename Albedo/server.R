...
shinyServer(function(input, output){
  ...
  observeEvent(input$update,{
    ...
    withProgress(message = 'Server Progress', value = 0, {
      ...
      engagement <- twitterQueryDataframe$favorite_count+twitterQueryDataframe$retweet_count
      twitterDataframe['engagement'] <- engagement
      ...
      # Output raw extracted tweets
      incProgress(1/progressSteps, detail = paste("Sending results"))
